...
__ALIGN_BEGIN static uint8_t HID_KEYBOARD_ReportDesc_6KRO[ HID_KEYBOARD_REPORT_DESC_SIZE ]  __ALIGN_END =
{
	...
	0x25 , 0x9F ,        //   LOGICAL_MAXIMUM ( 0x9F )
	0x05 , 0x07 ,        //   USAGE_PAGE      ( Keyboard )
    ...
    0x1A , 0x00 , 0x00 , //   USAGE_MINIMUM   ( 0x0000 )
    0x2A , 0xEA , 0x00 , //   USAGE_MAXIMUM   ( 0x00EA )
    0x16 , 0x00 , 0x00 , //   LOGICAL_MINIMUM ( 0x0000 )
...
uint32_t USBD_HID_GetPollingInterval( USBD_HandleTypeDef * pdev )
{
	...
	if( USBD_SPEED_HIGH == pdev->dev_speed )
	{
